...
export function createAccountsDetailsColumns(sym: string) {
  return [
    {
      key: "date",
      title: "Date",
      ...
      render: (value: unknown) => {
        ...
        return (
          <span className="text-xs font-semibold text-green-700">
            {sym}{amount.toLocaleString(undefined, { minimumFractionDigits: 0 })}
          </span>
        );
      },
    },
      ...
      render: (value: unknown) => {
        ...
        return (
          <span className="text-xs font-semibold text-gray-900">
            {sym}{balance.toLocaleString(undefined, { minimumFractionDigits: 0 })}
          </span>
        );
      },
    },
