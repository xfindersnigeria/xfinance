  ...
  return (
    <>
      <tr className="hover:bg-gray-50 border-t border-gray-100 cursor-pointer" onClick={() => setExpanded((v) => !v)}>
        ...
        <td className="px-4 py-2.5 text-sm font-medium text-gray-800">{row.projectName}</td>
    ...
    <div className="flex flex-col gap-4 pb-10">
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <h1 className="text-xl font-semibold">Supplies Consumption by Project</h1>
          <p className="text-sm text-primary">Supply usage and cost grouped by project</p>
        </div>
